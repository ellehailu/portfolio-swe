    ...
    return (
        <div className="about">
            <div className="bio">
                ...
                <p>My name is Elshadai but most people call me “Elle.” When I am not at my desk writing, you can find me outdoors hiking, paddleboarding, running or curled up on my couch with a cup of tea and a good book (there is really no in between).</p>
                </div>
